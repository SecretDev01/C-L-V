    ...
    do
        ...
        do
            local Lines = {
                ...
                {
                    -- FIXED: Shipped dividing outline line to a compact 45-pixel width
        ...
        local TitleHolder = New("Frame", {
            BackgroundTransparency = 1,
            -- FIXED: Left title holder housing the bird logo is now 45px wide
        ...
        -- REMOVED: Text header title generation block hidden so it mimics the clean icon strip profile
        --[[
        ...
        local RightWrapper = New("Frame", {
            ...
            -- FIXED: Aligned search container to right boundary next to our 45px bar layout
            Position = UDim2.new(0, 53, 0.5, 0),
            Size = UDim2.new(1, -102, 1, -16),
            Parent = TopBar,
        })
        ...
        Tabs = New("ScrollingFrame", {
            ...
            -- FIXED: Changed width scale from 0.3 to flat 45px width
        ...
        Container = New("Frame", {
            ...
            -- FIXED: Left container starts right after the 45px sidebar menu strip
