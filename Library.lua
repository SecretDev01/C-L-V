...
local function u22(p8, p9) 
    ...
    local function u18(p14) 
        ...
        local v17 = { Position = UDim2.new(u11.X.Scale, u11.X.Offset + v15.X, u11.Y.Scale, u11.Y.Offset + v15.Y), } 
    ...
    p8.InputBegan:Connect(function(p19) 
        if p19.UserInputType == Enum.UserInputType.MouseButton1 or p19.UserInputType == Enum.UserInputType.Touch then 
            ...
            p19.Changed:Connect(function() 
                if p19.UserInputState == Enum.UserInputState.End then u12 = false end 
            end) 
        end 
    end) 
    p8.InputChanged:Connect(function(p20) 
        if p20.UserInputType == Enum.UserInputType.MouseMovement or p20.UserInputType == Enum.UserInputType.Touch then u13 = p20 end 
    end) 
    _UserInputService.InputChanged:Connect(function(p21) 
        if p21 == u13 and u12 then u18(p21) end 
    end) 
end 
...
function u5.Window(_, p23) 
    ...
    _Frame2.InputBegan:Connect(function(p60) 
        if p60.UserInputType == Enum.UserInputType.MouseButton1 or p60.UserInputType == Enum.UserInputType.Touch then u59 = true end 
    end) 
    _UserInputService.InputEnded:Connect(function(p61) 
        if p61.UserInputType == Enum.UserInputType.MouseButton1 or p61.UserInputType == Enum.UserInputType.Touch then u59 = false end 
    end) 
    ...
    return { Tab = function(_, p63, p64) 
        ...
        _TextButton.MouseButton1Click:Connect(function() 
            ...
            while true do 
                ...
                if v78:IsA('TextButton') then 
                    ...
                    _TweenService:Create(v78.SelectedTab, TweenInfo.new(0, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(0, 3, 0, 0), }):Play() 
                ...
                _TweenService:Create(_TextButton, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundTransparency = 0.8}):Play() 
                _TweenService:Create(_Frame8, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(0, 3, 0, 15), }):Play() 
            ...
            while true do 
                local v82 
                v81, v82 = v79(v80, v81) 
                if v81 == nil then break end 
                u25 = string.gsub(_TextButton.Name, 'Server', '') .. '_Page' 
                if v82.Name == u25 then _UIPageLayout:JumpTo(v82) end 
            end 
        end) 
        if u24 == false then 
            local v83 = next 
            ...
            while true do 
                ...
                if v90:IsA('TextButton') then 
                    ...
                    _TweenService:Create(v90.SelectedTab, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(0, 3, 0, 15), }):Play() 
                ...
                _TweenService:Create(v88, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(0, 3, 0, 15), }):Play() 
        ...
        function u5.Alert(_, p91) 
            if game.CoreGui:FindFirstChild('AlertFrame') then 
                ...
                if _AlertFrame:FindFirstChild('Frame') then _AlertFrame.Frame:Destroy() end 
            end 
        ...
        return { Button = function(_, p99, p100) 
            ...
            _TextButton2.MouseButton1Click:Connect(function() p100() end) 
        end, Toggle = function(_, p109, p110, p111, p112) 
            ...
            _TextButton4.MouseButton1Click:Connect(function() 
                if u114 ~= false then 
                    ...
                    _TweenService:Create(_Frame12, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { BackgroundColor3 = _G.Primary, }):Play() 
                    _TweenService:Create(_TextButton4, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { BackgroundColor3 = _G.Dark, }):Play() 
                else 
                    u114 = true 
                    _UIStroke4.Thickness = 0 
                    _Frame12:TweenPosition(UDim2.new(0, 18, 0.5, 0), 'Out', 'Sine', 0.2, true) 
                    _TweenService:Create(_Frame12, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { BackgroundColor3 = _G.Dark, }):Play() 
                    _TweenService:Create(_TextButton4, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { BackgroundColor3 = _G.Primary, }):Play() 
                end 
                pcall(p112, u114) 
            end) 
            if v113 == true then 
        ...
        end, Dropdown = function(_, p127, p128, p129, p130) 
            local u131 = false 
            ...
            if p129 then _TextButton5.Text = ' ' .. p129 else _TextButton5.Text = ' Select Items' end 
            ...
            while true do 
                ...
                _TextButton6.MouseEnter:Connect(function() 
                    _TweenService:Create(_TextButton6, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { TextTransparency = 0, BackgroundTransparency = 0.8, }):Play() 
                ...
                _TextButton6.MouseLeave:Connect(function() 
                    _TweenService:Create(_TextButton6, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { TextTransparency = 0.5, BackgroundTransparency = 1, }):Play() 
                ...
                _TextButton6.MouseButton1Click:Connect(function() 
                    u131 = false 
                    _TextButton5.ClipsDescendants = true 
                    _TweenService:Create(_Frame15, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(1, -10, 0, 0), Visible = false, }):Play() 
                    p130(_TextButton6.Text) 
                    _TextButton5.Text = ' ' .. _TextButton6.Text 
                    _TweenService:Create(_Frame14, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(1, 0, 0, 40), }):Play() 
                end) 
            end 
            ...
            _TextButton5.MouseButton1Click:Connect(function() 
                if u131 ~= false then 
                    ...
                    u131 = true 
                    _TweenService:Create(_Frame15, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(1, -10, 0, 100), Visible = true, }):Play() 
                    _TweenService:Create(_Frame14, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Size = UDim2.new(1, 0, 0, 145), }):Play() 
                end 
            end) 
            return { Add = function(_, p152) 
                ...
                _TextButton7.MouseEnter:Connect(function() 
                    _TweenService:Create(_TextButton7, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { TextTransparency = 0, BackgroundTransparency = 0.8, }):Play() 
                ...
                _TextButton7.MouseLeave:Connect(function() 
                    _TweenService:Create(_TextButton7, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { TextTransparency = 0.5, BackgroundTransparency = 1, }):Play() 
                ...
                while true do 
                    ...
                    if v161:IsA('TextButton') then v161:Destroy() end 
                end 
            end, } 
        end, Slider = function(_, p162, p163, p164, p165, p166) 
            ...
            if Value == nil then 
                Value = p165 
                pcall(function() p166(Value) end) 
            end 
            local u182 = false 
            _Frame22.InputBegan:Connect(function(p183) 
                if p183.UserInputType == Enum.UserInputType.MouseButton1 or p183.UserInputType == Enum.UserInputType.Touch then u182 = true end 
            end) 
            _Frame20.InputBegan:Connect(function(p184) 
                if p184.UserInputType == Enum.UserInputType.MouseButton1 or p184.UserInputType == Enum.UserInputType.Touch then u182 = true end 
            end) 
            _UserInputService.InputEnded:Connect(function(p185) 
                if p185.UserInputType == Enum.UserInputType.MouseButton1 or p185.UserInputType == Enum.UserInputType.Touch then u182 = false end 
            end) 
            ...
            _TextBox.FocusLost:Connect(function() 
                if p164 < tonumber(_TextBox.Text) then _TextBox.Text = p164 end 
                _Frame21.Size = UDim2.new((_TextBox.Text or 0) / p164, 0, 0, 4) 
                _Frame22.Position = UDim2.new(1, 0, 0, -5) 
                local v187 = _TextBox 
                local v188 = tostring 
                local _Text = _TextBox.Text 
                if _Text then _Text = math.floor(_TextBox.Text / p164 * (p164 - p163) + p163) end 
                v187.Text = v188(_Text) 
                pcall(p166, _TextBox.Text) 
            end) 
        end, Textbox = function(_, p190, _, p191) 
            ...
            _TextBox2.FocusLost:Connect(function() p191(_TextBox2.Text) end) 
            _UICorner39.CornerRadius = UDim.new(0, 5) 
            _UICorner39.Parent = _TextBox2 
        end, Label = function(_, p197) 
            ...
            function v200.Set(_, p201) _TextLabel12.Text = p201 end 
            return v200 
        end, Seperator = function(_, p202) 
            ...
            _UIGradient.Color = ColorSequence.new({ ColorSequenceKeypoint.new(0, _G.Dark), ColorSequenceKeypoint.new(0.4, _G.Primary), ColorSequenceKeypoint.new(0.5, _G.Primary), ColorSequenceKeypoint.new(0.6, _G.Primary), ColorSequenceKeypoint.new(1, _G.Dark), }) 
